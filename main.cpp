...
int main()
  {
    //!!! Note: comment out codes about Checking Account object when we only testSavingsAccount
    
    Account account1(50.0); // create Account object
    SavingAccount account2(25.0, 0.03); // create SavingsAccount object
